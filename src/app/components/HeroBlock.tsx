...
function HeroBlock() {
  return (
    <section className="flex max-w-[1440px] relative overflow-hidden bg-[url('hero-block.png')] bg-cover bg-no-repeat bg-center justify-end md:h-full items-center md:py-[130px] sm:pb-[50%] pb-[75%]">
