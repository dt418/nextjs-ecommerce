...
export default function Header() {
  return (
    <div className="flex flex-col items-center justify-center relative overflow-hidden bg-white p-4 gap-4 max-w-[1440px] m-auto">
      <div className="flex flex-row justify-between items-center w-full gap-2 border-b py-4">
        <svg
          width={16}
          height={16}
          viewBox="0 0 16 16"
